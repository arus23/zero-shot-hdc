...
def main():
    ...
    parser.add_argument('--n_workers', type=int, default=16, help='Number of workers to split the dataset across')
    ...
    parser.add_argument('--strategy', type=int, default=1, choices=(1,2), help='Inference Strategy')
