...
# FINAL VERSION OF EVAL. USING K = 2 SD
...
def main():
    ...
    parser.add_argument('--k', type=float, default=2, help='percentage of prompts to consider')
    ...
    if args.extra is not None:
        run_folder = osp.join(LOG_DIR, args.dataset + "_finalSD_" +args.extra, name)
    else:
